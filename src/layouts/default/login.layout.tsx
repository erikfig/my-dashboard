    ...
    <div className={isDarkMode ? 'dark' : ''}>
      <div className="lg:grid lg:grid-cols-2 h-screen">
        ...
        <div className="hidden lg:flex justify-center items-center bg-gray-300 relative">
          <CardBackground src={`${import.meta.env.VITE_BASE_APP}programmer.jpeg`} className="bg-dark/80 rounded-full text-white flex flex-col gap-16 items-center justify-around">
